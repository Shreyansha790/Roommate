        ...
        <GlassCard className="p-8 sm:p-12">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-semibold tracking-tight leading-tight sm:text-6xl">Discover flatmates that match your <span className="bg-gradient-to-r from-cyan-300 via-violet-300 to-fuchsia-300 bg-clip-text text-transparent">lifestyle energy</span>.</h1>
              <p className="text-lg text-slate-300">Immersive roommate matching with social-first profiles, real compatibility signals, and premium discovery flows.</p>
