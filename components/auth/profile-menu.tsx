    ...
    <div className="relative">
      ...
      {open ? (
        <div className="absolute right-0 z-20 mt-2 w-44 rounded-md border bg-white p-1 shadow-lg">
          <Link href="/onboarding" className="block rounded px-3 py-2 text-sm text-slate-900 hover:bg-slate-100">Profile</Link>
          <Link href="/saved" className="block rounded px-3 py-2 text-sm text-slate-900 hover:bg-slate-100">Saved</Link>
          <Link href="/browse" className="block rounded px-3 py-2 text-sm text-slate-900 hover:bg-slate-100">Listings</Link>
          <button onClick={onLogout} disabled={loading} className="block w-full rounded px-3 py-2 text-left text-sm text-slate-900 hover:bg-slate-100">
